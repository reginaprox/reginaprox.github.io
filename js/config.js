...
var l_messages = [
	...
	"Проект был создан совместно Proxima и Mother Guillotine, GlobalPublic, T-420.",
	...
	"Все мы когда сделали ошибку, Амбрелла дала нам шанс к новой жизни, всяко лучше нежели гнить в тюрьме, - Наёмник U.B.C.S.",
	"Слыхал о Арклейских горах ? Там трава растет, прямо под ногами, всех их три вида, но чего я тебе рассказываю, ты и так о ней знаешь, - Наёмник U.B.C.S.",
	"У этого странного типа множество оружия на продажу, неизвестно как именно он попал сюда, но благо что хоть цены он у него как для людей, - Наёмник U.B.C.S.",
	"Эти полицейские, ну те что из R.P.D, дельные ребята, нам нужно держаться вместе что-бы выжить, - Наёмник U.B.C.S.",
];
